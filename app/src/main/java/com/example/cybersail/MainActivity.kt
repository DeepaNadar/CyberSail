...
import com.example.cybersail.MainActivity.Companion.myPager
import com.example.cybersail.MainActivity.Companion.tabsBtn
import com.example.cybersail.adapter.TabAdapter
import com.example.cybersail.databinding.ActivityMainBinding
import com.example.cybersail.databinding.BookmarkDialogBinding
import com.example.cybersail.databinding.MoreFeaturesBinding
import com.example.cybersail.databinding.TabsViewBinding
import com.example.cybersail.fragments.BrowseFragment
import com.example.cybersail.fragments.HomeFragment
import com.example.cybersail.model.Bookmark
import com.example.cybersail.model.Tab
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeView(){
        ...
        binding.tabsBtn.setOnClickListener {
            ...
            pBtn.setCompoundDrawablesWithIntrinsicBounds(ResourcesCompat.getDrawable(resources,R.drawable.baseline_home_24,theme),null,null,null)

            nBtn.setCompoundDrawablesWithIntrinsicBounds(ResourcesCompat.getDrawable(resources,R.drawable.sail_add,theme),null,null,null)
        }
        ...
        binding.settingsBtn.setOnClickListener{
            ...
            dialogBinding.saveBtn.setOnClickListener{
                ...
                }else Snackbar.make(binding.root,"Oops! Please open a web page \ud83d\ude15",3000).show()
            }
            ...
            dialogBinding.desktopBtn.setOnClickListener{
                ...
                frag?.binding?.webView?.apply {
                    isDesktopSite=if(isDesktopSite) {
                        ...
                        evaluateJavascript("document.querySelector('meta[name=\"viewport\"]').setAttribute('content',"+" 'width1024px,initial-scale='+(document.documentElement.clientWidth/1024));",null)
                        it.setIconTintResource(R.color.cool_blue)
