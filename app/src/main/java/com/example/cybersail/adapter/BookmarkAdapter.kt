...
import com.example.cybersail.databinding.BookmarkViewBinding
import com.example.cybersail.databinding.LongBookmarkViewBinding
       ...
       try {
        ...
        holder.root.setOnClickListener {
            when {
                ...
                else -> Snackbar.make(holder.root, "No Internet Connection \ud83d\ude41", 3000)
                    .show()
            }
        }
    }
