package com.example.cybersail.fragments
...
import com.example.cybersail.R
import com.example.cybersail.changeTab
import com.example.cybersail.databinding.FragmentBrowseBinding
        ...
        binding.webView.apply {
            ...
            webViewClient = object : WebViewClient() {
                ...
                override fun onLoadResource(view: WebView?, url: String?) {
                    ...
                    if (MainActivity.isDesktopSite) {
                        view?.evaluateJavascript(
                            "document.querySelector('meta[name=\"viewport\"]').setAttribute('content'," + " 'width1024px,initial-scale='+(document.documentElement.clientWidth/1024));",
                            null
                        )
                    }
                }
                ...
                override fun onPageStarted(view: WebView?, url: String?, favicon: Bitmap?) {
                    ...
                    mainRef.binding.progressIndicator.progress = 0
                    mainRef.binding.progressIndicator.visibility = View.VISIBLE
                    if (url!!.contains("you", false)) mainRef.binding.root.transitionToEnd()
                }

                override fun onPageFinished(view: WebView?, url: String?) {
                    super.onPageFinished(view, url)
                    mainRef.binding.progressIndicator.visibility = View.GONE
            ...
            webChromeClient = object : WebChromeClient() {
                ...
                override fun onProgressChanged(view: WebView?, newProgress: Int) {
                    ...
                    mainRef.binding.progressIndicator.progress = newProgress
                }
                ...
                if (imgUrl != null) {
                    if (imgUrl.contains("base64")) {
                        ...
                        MediaStore.Images.Media.insertImage(
                            requireActivity()
                                .contentResolver, finalImg, "Image", null
                        )
